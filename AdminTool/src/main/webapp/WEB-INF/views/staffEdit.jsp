	  				...
	  				<div class="col-md-6">
	  					<div class="content-box-large">
			  				<div class="panel-heading">
					            <div class="panel-title">スタッフ情報編集</div>
			  				...
			  				<div class="panel-body">
			  					<form:form modelAttribute="staff" action="staffEdit" method="post" role="form">
			  						<div class="form-group">
										<form:label path="staff_id">スタッフID</form:label>
										<form:input path="staff_id" type="text" value="${staff.getStaff_id()}" class="form-control" placeholder="Enter Staff ID" />
										<form:errors path="staff_id" />
									</div>
									<div class="form-group">
										<form:label path="staff_name">スタッフ名</form:label>
										<form:input path="staff_name" type="text" value="${staff.getStaff_name()}" class="form-control" placeholder="Enter Staff Name" />
										<form:errors path="staff_name" />
									</div>
									<div class="form-group">
										<form:label path="staff_pw">パスワード</form:label>
										<form:input path="staff_pw" type="text" value="${staff.getStaff_pw()}" class="form-control" placeholder="Enter Staff Password" />
										<form:errors path="staff_pw" />
									</div>
									<div class="form-group">
										<form:label path="staff_roll_id">権限ID</form:label>
										<form:input path="staff_roll_id" type="text" value="${staff.getStaff_roll_id()}" class="form-control" placeholder="Enter Staff Roll ID" />
										<form:errors path="staff_roll_id" />
									</div>
									<div class="form-group">
										<form:label path="experience">業務年数</form:label>
										<form:input path="experience" type="text" value="${staff.getExperience()}" class="form-control" placeholder="Enter Experience" />
									...
									<div class="form-group">
										...
										<form:input path="age" type="nuｍber" value="${staff.getAge()}" class="form-control" placeholder="Enter Age" />
										<form:errors path="age" />
									</div>
									<div class="form-group">
										<form:label path="mail">メールアドレス</form:label>
										<form:input path="mail" type="text" value="${staff.getMail()}" class="form-control" placeholder="Enter Mail Adress " />
										<form:errors path="mail" />
									</div>
									<div class="form-group">
										<form:label path="tel_no">電話番号</form:label>
										<form:input path="tel_no" type="nuｍber" value="${staff.getTel_no()}" class="form-control" placeholder="Enter TEL Numbrer " />
